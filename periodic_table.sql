...
--
-- Name: properties fk_atomic_nunber; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_atomic_nunber FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
